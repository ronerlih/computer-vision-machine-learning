...
namespace LearningToPaint
{
    ...
    /// </summary>
	public class LearningToPaint : MonoBehaviour
    {
        ...
        void Start ()
        {
            ...
            int[] labels = {1, -1, -1, -1};
            float[] trainingData = { 499, 10, 255, 10, 499, 255, 10, 499 };
            ...
            Imgproc.circle (image, new Point (499, 10), 5, new Scalar (0, 0, 0, 255), thickness, lineType, 0);
            Imgproc.circle (image, new Point (255, 10), 5, new Scalar (255, 255, 255, 255), thickness, lineType, 0);
            Imgproc.circle (image, new Point (499, 255), 5, new Scalar (255, 255, 255, 255), thickness, lineType, 0);
            Imgproc.circle (image, new Point (10, 499), 5, new Scalar (255, 255, 255, 255), thickness, lineType, 0);
